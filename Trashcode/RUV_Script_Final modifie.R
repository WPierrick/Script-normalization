...
densityPlot(gmSetSwFlt, sampGroups = targets$Gender, main = "Beta sorted by gender", xlab = "Beta")
dev.off()


jpeg("02_densityplotsampleset.jpg")
densityPlot(gmSetSwFlt, sampGroups = targets$SAMPLE.SET, main = "Beta by sample set", xlab = "Beta")
dev.off()

jpeg("02_densityplotphenotype.jpg")
densityPlot(gmSetSwFlt, sampGroups = targets$Gender, main = "Beta sorted by phenotype", xlab = "Beta")
dev.off()


jpeg("03_densityplotgender.jpg")
densityPlot(gmSetQFlt, sampGroups = targets$Gender, main = "Beta sorted by gender", xlab = "Beta")
dev.off()


jpeg("03_densityplotsampleset.jpg")
densityPlot(gmSetQFlt, sampGroups = targets$SAMPLE.SET, main = "Beta by sample set", xlab = "Beta")
dev.off()

jpeg("03_densityplotphenotype.jpg")
densityPlot(gmSetQFlt, sampGroups = targets$Gender, main = "Beta sorted by phenotype", xlab = "Beta")
dev.off()
